...
public class User {
    ...
    public User(String id, String salt, String pass, boolean freeze, String name, String email, String sex, String intro,String isSign) {
    ...
    public String toString() {
        return "[id=" + id + ", salt=" + salt + ", pass=" + pass + ", freeze=" + freeze + ", name=" + name
                + ", email=" + email + ", sex=" + sex + ", intro=" + intro +  ", isSign=" + isSign+"]";
    }
