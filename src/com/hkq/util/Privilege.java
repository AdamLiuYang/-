...
public class Privilege {
    ...
    private static final String[] adminServletPathes = {
            "/admin/login", "/admin/LoginController", "/admin/LogoutController", "/admin/home", "/admin/schedule",
            "/admin/manage_user", "/admin/search", "/admin/UpdateUserController", "/admin/AllUserController", "/admin/SearchController", "/admin/ScheduleController"
            , "/admin/UpdateScheduleController"
    };
