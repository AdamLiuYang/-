...
<div>
    <a href="${pageContext.request.contextPath}/UserSignController" target="_self">>签到</a><br/>
    <a href="${pageContext.request.contextPath}/changeToiletListController" target="_self">>修改洗手液/厕纸</a><br/>
    <a href="${pageContext.request.contextPath}/admin/ScheduleController?role=user" target="_self">>排班</a><br/>
    ...
    <br/>
    <a href="${pageContext.request.contextPath}/user">厕所显示页面</a>
</div>
